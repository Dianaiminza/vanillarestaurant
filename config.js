...
module.exports={
 PORT: process.env.PORT || 5000,
  ...
  GOOGLE_API_KEY:process.env.GOOGLE_API_KEY || 'https://maps.googleapis.com/maps/api/js?key=AIzaSyA_o7FM2m9ZPRceHDT9EDgrVtFIslIQHQ8&q=senior+assisted+care+near+me&zoom=9',
