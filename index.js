...
app.get('/api/config/google', (req, res) => {
  res.send(process.env.GOOGLE_API_KEY || 'https://www.google.com/maps/embed/v1/place?key=AIzaSyA_o7FM2m9ZPRceHDT9EDgrVtFIslIQHQ8&q=senior+assisted+care+near+me&zoom=9');
});
